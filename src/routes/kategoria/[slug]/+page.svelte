        ...
        {#if category}
            ...
            {#if hasActiveFilters}
                <div class="chips">
                    ...
                    {/each}
                    <button class="chip chip--clear" on:click={clearFilters}>
                        ...
                        <div class="fl__sec">
                            ...
                            {#if openSections.price}
                                <div class="fl__body">
                                    ...
                                    {#if priceRange.max > 0}
                                        <div class="fl__price-range">{formatPrice(priceRange.min)} – {formatPrice(priceRange.max)}</div>
                                    {/if}
                ...
                <div class="cat-content">
                    ...
                    <div class="prods">
                        <div class="prods__info">
                            Zobrazených <strong>{products.length}</strong> z <strong>{totalProducts}</strong> produktov
                        </div>
                                        ...
                                        <div class="pc__body">
                                            ...
                                            <div class="pc__bottom">
                                                ...
                                                {#if product.offer_count > 1}
                                                    <div class="pc__offers">v {product.offer_count} obchodoch</div>
                                                {/if}
...
.fl__inner::-webkit-scrollbar { width: 4px; }
.fl__inner::-webkit-scrollbar-thumb { background: #d1d5db; border-radius: 4px; }
...
.fl__price-ok {
    padding: 8px 12px; background: #c4956a; color: #fff;
    border: none; border-radius: 8px; font-size: 12px;
    font-weight: 600; cursor: pointer; flex-shrink: 0;
    transition: background 0.15s;
}
.fl__price-ok:hover { background: #b8875c; }
.fl__price-range { font-size: 11px; color: #9ca3af; margin-top: 6px; }
...
.fl__price-quick button {
    ...
    color: #6b7280; background: #f5f6f8; border: 1px solid #e5e7eb;
...
.subcat__ico {
    width: 30px; height: 30px; background: #f5f6f8;
...
/* ========================================
   PRODUCT CARD - no jump/hover animation
   ======================================== */
.pc {
