import{s as Tn,n as en,d as u,r as Dn,a as ve,x as mt,i as ct,b as e,y as st,q as d,c as s,e as p,g as m,w as I,f as n,h as r,j as b,t as l,R as _n,k as En,B as yn,m as Pn}from"../chunks/DFArySuv.js";import{e as hn}from"../chunks/BCvDt_cB.js";import{S as In,i as Sn}from"../chunks/s82JoINO.js";function pn(i,o,c){const v=i.slice();return v[26]=o[c],v}function fn(i){let o,c;return{c(){o=r("div"),c=l(i[3]),this.h()},l(v){o=s(v,"DIV",{class:!0});var z=p(o);c=n(z,i[3]),z.forEach(u),this.h()},h(){d(o,"class","conv-toast svelte-1o5zbdd")},m(v,z){ct(v,o,z),e(o,c)},p(v,z){z&8&&ve(c,v[3])},d(v){v&&u(o)}}}function mn(i){let o,c,v,z="Tracking skript pre Thank You stránku",y,h,V="📋 Kopírovať kód",_,t,D,g="{",P,E,x="{",q,S,M,R,L,$,ae="}",B,O,ne="{",J,j,N="}",k,U,K="{",F,W,ue="{",le,G,_e="{",oe,Y,se="}",te,Z,Q="{",C,Oe,Re="}",re,fe,xe="}",Ie,Se,be="}",je,Ne,me="}",de,Le,Be,ce;return{c(){o=r("div"),c=r("div"),v=r("span"),v.textContent=z,y=b(),h=r("button"),h.textContent=V,_=b(),t=r("pre"),D=l(`<!-- MegaPrice.sk Conversion Tracking -->
<script>
(function() `),P=l(g),E=l(`
